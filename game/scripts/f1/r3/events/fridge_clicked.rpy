...
label fridge_clicked:
    ...
    if fridge_count == 4:
        ...
        g "そんなことをしていたら、さすがに君も死んでしまうか"

        g "せめて、パスワードの文字数や、含まれる文字の種類がわかるといいんだけどね"

        g "例えば、パスワードが3文字で、数字しか含まないなら、パスワードの候補は000から999までの1000通りになる"

        g "これが事前にわかっていれば、安心して順番に試せるのに......"
